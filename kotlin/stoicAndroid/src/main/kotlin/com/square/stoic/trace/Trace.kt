package com.square.stoic.trace

import com.square.stoic.trace.Rule.RuleLeaf
import com.square.stoic.trace.Rule.RuleMap
import com.square.stoic.Stack
import com.square.stoic.helpers.eprintln
import com.square.stoic.helpers.println
import com.square.stoic.jvmti.JvmtiClass
import com.square.stoic.jvmti.JvmtiField
...
import com.square.stoic.jvmti.magics.c
import com.square.stoic.jvmti.magics.f
import com.square.stoic.threadlocals.jvmti
import com.square.stoic.trace.ResultTree.ResultLeaf
import com.square.stoic.trace.ResultTree.ResultNode
...
sealed class Rule {
  class RuleMap(private val default: Rule?, private val rules: List<Pair<String?, Rule?>>): Rule() {
     ...
     * Gather members.
     *
     * Given a map of name/field, apply com.square.stoic.trace.rules to produce a list of name/field/com.square.stoic.trace.Rule triples
     * Optionally, populate a list of unmatched com.square.stoic.trace.rules
     */
    fun <T> gather(
  ...
  // JvmtiClass/JvmtiMethod -> com.square.stoic.trace.MethodEvaluator/com.square.stoic.trace.ValueEvaluator
...
//  fun apply(obj: Any?): com.square.stoic.trace.ResultTree {
//    if (obj == null) {
//      return com.square.stoic.trace.ResultTree("null")
//    } else {
//      return com.square.stoic.trace.ResultTree(
//        subrules.map { (field, subrule) -> Pair(field.name, subrule.apply(field.get(obj))) })
//    }
//  }
//}

//class com.square.stoic.trace.MethodEvaluator(
//  val name: String,
//  val jvmtiMethod: JvmtiMethod,
//  private val subrules: List<Pair<LocalVariable<*>, TypeEvaluator>>
//) {
//  fun apply(frame: StackFrame): com.square.stoic.trace.ResultTree {
//    return com.square.stoic.trace.ResultTree(
//      "${jvmtiMethod.clazz.simpleName}.${jvmtiMethod.name}",
//      subrules.map { (localVar, subrule) ->
//           com.square.stoic.trace.ResultTree(localVar.name!!, subrule.apply(frame.get(localVar)))
//          })
//  }
//}

// key/value pairs, where the value is either a String or a com.square.stoic.trace.ResultTree
...
// Structured com.square.stoic.trace.trace declaration. This is a complex API, but you can get started by following
// examples rather than reading the entire documentation.
//
// e.g.
// com.square.stoic.trace.trace(
//   "android/view/View" to com.square.stoic.trace.getInclude,
// )
//
// com.square.stoic.trace.trace(
//   "android/view/View" to com.square.stoic.trace.getIncludeEach,
// )
//
// com.square.stoic.trace.trace(
//   "android/view/View" to ruleMap(
//     "getChildCount" to com.square.stoic.trace.getIncludeEach,
//   )
// )

// com.square.stoic.trace.trace(
//   "android/view/View" to ruleMap(
//     default = com.square.stoic.trace.getIncludeEach,
//     "getChildCount" to com.square.stoic.trace.getOmit,
//   )
// )
//
// We take in a list of com.square.stoic.trace.rules describing what to com.square.stoic.trace.trace. We type-check them to produce a list of
// evaluators, describing how to capture state at each breakpoint. When the evaluators run, they
// produce a com.square.stoic.trace.ResultTree, which is passed to the `consume` parameter.
//
...
//// This describes special com.square.stoic.trace.rules for stringifying certain arguments
...
//      "action") to { value: Any? ->
//    com.square.stoic.trace.getConstantNameByValue(
...
//    "performAccessibilityAction",
//    "flags") to { value: Any? ->
//    com.square.stoic.trace.getFlagNames(
//      AccessibilityNodeInfo::class.java,
//      "FLAG_",
//      value as Int,
//      true)
